...
/**
 * Concrete class for Beverage products.
 * Extends PerishableProduct.
 */
public class Beverages extends PerishableProduct {

    /**
     * Constructs a new Beverage product.
     *
     ...
     */
    public Beverages(String productID, String name, double price, int quantityInStock, List<String> subcategories, String brand, String variant, LocalDate expirationDate) {
