...
/**
 * Concrete class for Pharmacy products.
 * Extends PerishableProduct.
 */
public class Pharmacy extends PerishableProduct {

    /**
     * Constructs a new Pharmacy product.
     *
     ...
     */
    public Pharmacy(String productID, String name, double price, int quantityInStock, List<String> subcategories, String brand, String variant, LocalDate expirationDate) {
